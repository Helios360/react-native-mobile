  ...
  const messages = {
    ...
    "messages": [
      ...
      },
      {
        "id": 4,
        "type": "to",
        "text": "It shouldn’t be surprising, then, that many of the biggest proponents of banning performance enhancing drugs in sports are also suspect of some The Rosenkranz Foundation"
      }
    ]
  };
